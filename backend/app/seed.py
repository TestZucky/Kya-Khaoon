...
CONCEPTS: list[dict] = [
    dict(name="Chicken Biryani", search_query="chicken biryani", cuisine="Hyderabadi",
         ...
         meals=["lunch", "dinner"], image_url=_IMG.format("photo-1563379091339-03b21ab4a4f8")),
    ...
    dict(name="Chicken Shawarma Bowl", search_query="chicken shawarma bowl", cuisine="Middle Eastern",
         ...
         meals=["lunch", "dinner", "snack"], image_url=_IMG.format("photo-1633945274405-b6c8069047b0")),
    ...
    dict(name="Veg Hakka Noodles", search_query="veg hakka noodles", cuisine="Chinese",
         ...
         meals=["lunch", "dinner"], image_url=_IMG.format("photo-1585032226651-759b368d7246")),
    ...
    dict(name="Masala Dosa", search_query="masala dosa", cuisine="South Indian",
         ...
         meals=["breakfast", "lunch"], image_url=_IMG.format("photo-1630383249896-424e482df921")),
    dict(name="Korean Spicy Chicken Noodles", search_query="korean spicy chicken noodles",
         ...
         meals=["lunch", "dinner"], image_url=_IMG.format("photo-1668236543090-82eba5ee5976")),
    ...
    dict(name="Smash Burger", search_query="smash burger", cuisine="American",
         ...
         meals=["lunch", "dinner", "snack"], image_url=_IMG.format("photo-1550547660-d9450f859349")),
    ...
    dict(name="Idli Sambar", search_query="idli sambar", cuisine="South Indian",
         ...
         meals=["breakfast"], image_url=_IMG.format("photo-1610192244261-3f33de3f55e4")),
]
